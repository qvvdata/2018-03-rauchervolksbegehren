...
write.csv(analysis_rvb_gem %>% select(GKZ,Name, Anteil, `türkis/grün-Anteil`, `türkis Anteil`, `grün Anteil`, `rurb`, Unterschriften) %>% rename(tkgr=`türkis/grün-Anteil`, pct=Anteil, Summe=Unterschriften), "output/datawrapper/analysis_rvb_gem.csv")
